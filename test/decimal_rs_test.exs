defmodule DecimalRsTest do
  ...
  test "integer base values with decimal powers" do
    #assert_power(2, "2.5", "5.656854249492380195206754897") mpedecimal
    #                       "5.656854249492380195206754897" wolfram alpha
    #                       "5.6568542462234976341751322997" rust_decimal
    assert_power(2, "2.5", "5.6568542462234976341751322997")
  ...
  defp assert_power(base, exponent, expected) do
    base = Decimal.new(base)
    exponent = Decimal.new(exponent)
    expected = Decimal.new(expected)
    assert Decimal.eq?(DecimalRs.pow(base, exponent), expected)
  end
end
