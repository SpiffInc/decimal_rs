...
Benchee.run(
  %{
    ...
    "DecimalRs.pow(\"4.0\",\"0.5\")" => fn -> DecimalRs.pow(value2, value1) end,
    "DecimalRs.pow(\"1234567890.1234567890123456\",\"0.5\")" => fn -> DecimalRs.pow(value4, value1) end,
    "DecimalRs.pow(\"1234567890.1234567890123456\",\"0.1234567890123456789012345\")" => fn -> DecimalRs.pow(value4, value0) end
  },
  warmup: 1,
  time: 2
)
